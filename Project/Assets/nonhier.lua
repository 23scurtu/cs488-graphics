...
b1 = gr.nh_box('b1', {-300, -125, 0}, 200)
scene_root:add_child(b1)
b1:set_material(mat4)

s6 = gr.nh_sphere('s6', {-0, -25, 100}, 50)
...
white_light = gr.light({-100.0, 150.0, 400.0}, {0.9, 0.9, 0.9}, {2, 0, 0}) -- 0.00002
magenta_light = gr.light({400.0, 100.0, 150.0}, {0.7, 0.0, 0.7}, {2, 0, 0})

gr.render(scene_root, 'nonhier.png', 512, 512, --256, 256,
