...
mirror = gr.cmaterial({0.9,0.9,0.9}, {0.95,0.95,0.95}, 100)
double_sided_mirror = gr.cmaterial({0.9,0.9,0.9}, {0.95,0.95,0.95}, 100, 0.1, 1, 0, 0)
...
inf_mirror:scale(25,25,25)
inf_mirror:translate(50,25, 0)
