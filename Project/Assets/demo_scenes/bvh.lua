...
s2 = gr.nh_sphere('s2', {2, 0, 0}, 0.5)
n2:add_child(s2)
s2:set_material(mat1)

n3 = gr.node('n3')
n3:translate(-1.5,5,1)
n2:add_child(n3)
...
-- s4 = gr.nh_sphere('s3', {-15, 0, 70}, 0.5)
-- n3:add_child(s4)
-- s4:set_material(mat5)

steldodec = gr.mesh( 'dodec', '../buckyball.obj' )
steldodec:set_material(mat3)
steldodec:scale(3,3,3)
steldodec:translate(25,-20,20)
