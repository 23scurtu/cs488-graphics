...
s = 1/8--1/8
mat1 = gr.perlin_material(64, {s,s,s}, {1.0,1.0, 1.0}, {0.5, 0.5, 0.5}, 25, 0, 0, 0, 0, 0)
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.5, 0.5}, 25, 0)
...
white_light = gr.light({200, 200, 400}, {1,1,1}, {1.5, 0, 0})
